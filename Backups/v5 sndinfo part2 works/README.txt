Organization and Methods:
	...
	as well as a billboard comment denoting where similar functions are grouped (e.g. parsing CS229 functions).
...
sndinfo:
	...
	search for the SSND chunk and gather it's block information and put it into storage
	parse the rest of the file
	after the file has been parsed, go through storage, and check is the sample are within bit depth limits
